...
% This is the saved workspace at the end of AIClinician_sepsis3_def_160219.m
load(join([filepath, '/final_sepsis.mat'], ''));
...
save(join([filepath, '/mimic-table.mat'], ''));
writetable(MIMICtable,join([filepath, '/mimic-table.csv'], ''),'Delimiter',',');
