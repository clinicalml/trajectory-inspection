...
filepath='<REPLACE WITH DATA PATH>';

tic
% This was missing
R=importdata('reference_matrices.mat');
Reflabs=R.Reflabs;
Refvitals=R.Refvitals;
sample_and_hold=R.sample_and_hold;

abx=table2array(readtable(join([filepath, '/abx.csv'], '')));
culture=table2array(readtable(join([filepath, '/culture.csv'], '')));
microbio=table2array(readtable(join([filepath, '/microbio.csv'], '')));
demog=(readtable(join([filepath, '/demog.csv'], '')));
ce010=table2array(readtable(join([filepath, '/ce010000.csv'], '')));
ce1020=table2array(readtable(join([filepath, '/ce1000020000.csv'], '')));
ce2030=table2array(readtable(join([filepath, '/ce2000030000.csv'], '')));
ce3040=table2array(readtable(join([filepath, '/ce3000040000.csv'], '')));
ce4050=table2array(readtable(join([filepath, '/ce4000050000.csv'], '')));
ce5060=table2array(readtable(join([filepath, '/ce5000060000.csv'], '')));
ce6070=table2array(readtable(join([filepath, '/ce6000070000.csv'], '')));
ce7080=table2array(readtable(join([filepath, '/ce7000080000.csv'], '')));
ce8090=table2array(readtable(join([filepath, '/ce8000090000.csv'], '')));
ce90100=table2array(readtable(join([filepath, '/ce90000100000.csv'], '')));
labU=[ table2array(readtable(join([filepath, '/labs_ce.csv'], ''))) ; table2array(readtable(join([filepath, '/labs_le.csv'], '')))  ];
MV=table2array(readtable(join([filepath, '/mechvent.csv'], '')));
inputpreadm=table2array(readtable(join([filepath, '/preadm_fluid.csv'], '')));
inputMV=table2array(readtable(join([filepath, '/fluid_mv.csv'], '')));
inputCV=table2array(readtable(join([filepath, '/fluid_cv.csv'], '')));
vasoMV=table2array(readtable(join([filepath, '/vaso_mv.csv'], '')));
vasoCV=table2array(readtable(join([filepath, '/vaso_cv.csv'], '')));
UOpreadm=table2array(readtable(join([filepath, '/preadm_uo.csv'], '')));
UO=table2array(readtable(join([filepath, '/uo.csv'], '')));
toc
...
%save cohort
writetable(sepsis,join([filepath, '/sepsis_mimiciii.csv'], ''),'Delimiter',',');
save(join([filepath, '/final_sepsis.mat'], ''));
